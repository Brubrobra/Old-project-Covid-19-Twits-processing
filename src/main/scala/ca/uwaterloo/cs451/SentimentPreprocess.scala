...
spark-submit --class ca.uwaterloo.cs451.COVID19Predictor.SentimentPreprocess \\ 
    target/finalproject-1.0.jar --input data/twitter --output data/sentiment-processed
*/
